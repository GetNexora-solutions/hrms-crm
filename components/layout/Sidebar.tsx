...
const getRoutes = (role: Role) => {
  const routes = [
    ...
    { label: 'Onboarding', icon: UserPlus, href: '/onboarding', roles: ['super_admin', 'hr', 'admin'] },
    ...
    { label: 'Recruitment', icon: Briefcase, href: '/recruitment', roles: ['super_admin', 'hr', 'md', 'recruiter'] },
    { label: 'Assets', icon: MonitorSmartphone, href: '/assets', roles: ['super_admin', 'hr', 'md', 'admin'] },
    { label: 'Expenses', icon: CreditCard, href: '/expenses', roles: ['super_admin', 'hr', 'md', 'finance', 'manager', 'employee'] },
    { label: 'CRM', icon: Target, href: '/crm', roles: ['super_admin', 'md', 'manager', 'employee'] },
    { label: 'Projects', icon: FolderKanban, href: '/projects', roles: ['super_admin', 'md', 'manager', 'employee'] },
